...
def write_to_bin(url_file, out_prefix):
    """Reads the .story files corresponding to the urls listed in the url_file and writes them to an out_file."""
    ...
    with open(out_prefix + ".source", "wt") as source_file, open(
        ...
        for idx, s in enumerate(story_fnames):
            ...
            if os.path.isfile(os.path.join(cnn_stories_dir, s)):
                ...
                print(
                    "Error: Couldn't find story file %s in either story directories %s and %s."
