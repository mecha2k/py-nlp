# Original file is located at https://colab.research.google.com/drive/1u8PXgqQgbSbkCYqBxFOz4I_fOrTUewHx
...
with open("../data/transformers/sample_v2.txt", mode="r", encoding="utf-8") as file:
