...
#   <td>
#     <a target="_blank" href="https://nbviewer.org/github/rickiepark/nlp-with-pytorch/blob/master/chapter_7/7_3_surname_generation/7_3_Model1_Unconditioned_Surname_Generation.ipynb"><img src="https://jupyter.org/assets/share.png" width="60" />주피터 노트북 뷰어로 보기</a>
#   </td>
#   <td>
#     <a target="_blank" href="https://colab.research.google.com/github/rickiepark/nlp-with-pytorch/blob/master/chapter_7/7_3_surname_generation/7_3_Model1_Unconditioned_Surname_Generation.ipynb"><img src="https://www.tensorflow.org/images/colab_logo_32px.png" />구글 코랩(Colab)에서 실행하기</a>
#   </td>
# </table>
...
get_ipython().system("wget https://git.io/Jqfup -O data/download.py")
get_ipython().system("wget https://git.io/Jqfze -O data/get-all-data.sh")
